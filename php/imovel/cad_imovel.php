...
<html>
    ...
    <body>
        ...
        ?>
        <div class="box">
            <form action="proc_cad_imovel.php" method="POST">
                <fieldset>
                    <legend>Cadastro Imovel</legend>
                    <br>
                    <div class="inputBox">
                        <input type="text" name="numIptu" class="inputUser" required>
                        <label class="labelInput">Numero registro do IPTU</label><br><br>
                    </div>
                    <br><br><br>
                    <div class="inputBox">
                        <input type="text" name="endereco" class="inputUser" required>       
                        <label class="labelInput">Endereço</label><br><br>
                    </div>
                    <br><br><br>
                    <div class="inputBox">
                        <input type="text" name="valor" class="inputUser" required><br><br>
